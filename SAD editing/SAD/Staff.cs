    ...
    public partial class Staff : Form
    {
        ...
        private void btn_add_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                "(firstname, lastname, address, contact, usertype, username, password, userstatus, date_added, date_modified)" + " VALUES('" + txt_fname.Text + "','" + txt_lname.Text + "','" + txt_address.Text + "','" + mtxt_contact.Text + "','" + cb_usertype.Text + "','" + txt_username.Text + "','" + txt_pass.Text + "','" + cb_userstatus.Text + "', current_timestamp(), current_timestamp())";
                conn.Open();
                MySqlCommand comm = new MySqlCommand(query, conn);
        ...
        private void dtgv_CellClick_1(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex > -1)
            {
                ...
                cb_userstatus.Text = dtgv.Rows[e.RowIndex].Cells["userstatus"].Value.ToString();
        ...
        private void btn_update_Click(object sender, EventArgs e)
        {
            string query = "UPDATE Staff " +
               ...
               "', " + "userstatus = '" + cb_userstatus.Text + "', " + "date_modified = current_timestamp() WHERE staff_id = '" + selected_staff_id + "';";
